...
class Cell {
  ...
  final int col;
  var visited = false;
  var wallon = List<bool>(Wall.values.length);

  Cell(this.row, this.col) {
    for (var i = 0; i != wallon.length; ++i) wallon[i] = true;
  }
}
  ...
  Iterable<Cell> generate() sync* {
    ...
    while (true) {
      ...
      if (nextMove != null) {
        ...
        nextMove.cellFrom.wallon[wallFrom.index] = false;
        nextMove.cellTo.wallon[wallTo.index] = false;
